    ...
    public static ArrayList<ArrayList<String>> getDataForAI() {
        ...
        try (Connection connection = DriverManager.getConnection(connectionUrl);
            ...
            while (resultSet.next()) {
                ...
                a.add(Integer.toString(resultSet.getInt(6)));
                data.add(a);
            }
