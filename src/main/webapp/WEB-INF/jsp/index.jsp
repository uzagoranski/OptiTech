...
<div class="page-wrapper">
    ...
    <div class="page-container">
        ...
        <div class="full-width">
            ...
            <div class="half-image" style="right: 0; background-size:cover; background-repeat: no-repeat; background-image:url('https://www.kivi.si/portals/0/Images/OptiTech/OptiTech-www_screen.jpg')">
            </div>
            <div class="site-width-limit">
                <div class="col-wrapper">
                    <div class="col col-1-2">
                        <span class="dashboardH1">Ecosystem of </span> <span class="blueDashboardH1">data</span> <span class="dashboardH1">and</span> <span class="blueDashboardH1">management</span>
                        <br/><br/>
                        <p>OptiTech is a "connected vehicle" platform for processing and management of data from multiple vehicles, integrated with external and internal systems and users.</p>
                        <br/>
                        <p>The key feature of the platform is that is considering and building upon the needs and requirements of different participants, such as drivers, service shops, insurance companies, vehicle manufacturers etc., thus providing an ever- improving user experience and as a consequence an easier fleet management for ecosystem users.</p>
                    </div>
                    <div class="col col-1-2">
                    </div>
                </div>
        ...
        <div class="full-width">
            ...
            <div class="half-image" style="background-size:cover; background-repeat: no-repeat; background-image:url('https://www.kivi.si/Portals/0/Images/Viapan-4.jpg')">
            </div>
            <div class="site-width-limit">
                <div class="col-wrapper">
                    <div class="col col-1-2">
