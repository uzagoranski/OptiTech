...
*/
(function(a){"object"===typeof module&&module.exports?(a["default"]=a,module.exports=a):"function"===typeof define&&define.amd?define("highcharts/modules/price-indicator",["highcharts","static/highcharts/modules/stock"],function(c){a(c);a.Highcharts=c;return a}):a("undefined"!==typeof Highcharts?Highcharts:void 0)})(function(a){function c(a, c, f, g){a.hasOwnProperty(c)||(a[c]=g.apply(null,f))}a=a?a._modules:{};c(a,"modules/price-indicator.src.js",[a["parts/Globals.js"]],function(a){var c=a.addEvent,f=a.merge,
